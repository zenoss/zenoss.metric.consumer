 ...
 */
@Component
public class ZingQueue implements TsdbMetricsQueue {
    ...
    MetricName incomingMetricName() {
        return new MetricName(ZingQueue.class, "totalIncoming");
    }

    MetricName outgoingMetricName() {
        return new MetricName(ZingQueue.class, "totalOutgoing");
    }

    MetricName inFlightMetricName() {
        return new MetricName(ZingQueue.class, "totalInFlight");
    }

    MetricName clientCountMetricName() {
        return new MetricName(ZingQueue.class, "totalClientCount");
    }

    MetricName errorsMetricName() {
        return new MetricName(ZingQueue.class, "totalErrors");
    }

    MetricName lostMetricName() {
        return new MetricName(ZingQueue.class, "totalLost");
    }

    MetricName receivedMetricName() {
        return new MetricName(ZingQueue.class, "totalReceived");
    }

    MetricName rejectedMetricName() {
        return new MetricName(ZingQueue.class, "totalRejected");
    }

    MetricName highCollisionMetricName() {
        return new MetricName(ZingQueue.class, "totalHighCollision");
    }

    MetricName lowCollisionMetricName() {
        return new MetricName(ZingQueue.class, "totalLowCollision");
    }

    MetricName clientCollisionMetricName() {
        return new MetricName(ZingQueue.class, "totalClientCollision");
    }

    MetricName broadcastHighCollisionMetricName() {
        return new MetricName(ZingQueue.class, "totalBroadcastHighCollision");
    }

    MetricName broadcastLowCollisionMetricName() {
        return new MetricName(ZingQueue.class, "totalBroadcastLowCollision");
    }

    MetricName sentClientCollisionMetricName() {
        return new MetricName(ZingQueue.class, "totalSentClientCollision");
    }

    private static final Logger log = LoggerFactory.getLogger(ZingQueue.class);
